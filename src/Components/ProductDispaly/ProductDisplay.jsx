    ...
    <div className="flex flex-col md:flex-row items-center md:items-start space-y-5 md:space-y-0 md:space-x-4">
      ...
      <div className="flex flex-col py-5 space-y-5 w-[90%]">
        ...
        <div>
          ...
          perspiciatis porro expedita deserunt, dolores veritatis quas, deleniti
          dicta cumque similique ipsam autem. Odio possimus exercitationem ad
          commodi corrupti quibusdam optio.
        </div>
        {/* select size */}
